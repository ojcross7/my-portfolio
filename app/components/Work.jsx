  ...
  return (
    ...
    id='work' className='w-full px-[12%] py-10 scroll-mt-20'>
      ...
      className='text-center mb-2 text-5xl font-Ovo'>
        ...
        Welcome to my portfolio ! Explore my collection of projects showcasing my expertise in web development and Graphic Design.  
        </motion.p>
        ...
        className='grid grid-cols-auto my-10 gap-5 dark:text-black'>
          {workData.map((project, index)=>(
            ...
            key={index} 
            className='aspect-square bg-no-repeat bg-cover bg-center rouded-lg
            relative cursor-pointer group'
            style={{backgroundImage: `url(${project.bgImage})` }}>
              
              <div className='bg-white w-11/12 rouded-md absolute bottom-5
              left-1/2 -translate-x-1/2 py-3 px-5 flex items-center 
              justify-between group-hover:button-7'>
              <div>
